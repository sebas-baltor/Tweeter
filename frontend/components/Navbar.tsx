...
const notoSans = Noto_Sans({weight:"500",style:"normal",subsets:["latin"]})
export default function Navbar() {
  const floatingMenu = useRef<HTMLDivElement>(null);
  return (
    <nav className={`${poppins.className} w-full fixed z-10 top-0 right-0 flex items-center justify-between px-6 py-4 bg-white shadow-md`}>
      <div>
        <Image
          src={logo}
      ...
      <div className="relative">
        <div onClick={()=>{
          ...
          >
            ...
            <div className={`${notoSans.className} hidden lg:flex items-center`}>
        ...
        <div ref={floatingMenu} className={`${notoSans.className} absolute right-0 top-[200%] w-40 py-2 p-3 bg-white rounded-md shadow-md z-10 flex flex-col gap-1`}>
          <a
            href="/profile/1"
